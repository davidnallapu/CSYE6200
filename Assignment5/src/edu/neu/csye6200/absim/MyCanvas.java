...
public class MyCanvas extends JPanel implements Observer {
	...
	public MyCanvas() {
		try {
//			System.out.println(MyCanvas.class.getResource("/res/boat.png"));
//			String temp = new File("").getAbsolutePath()+"/src/edu/neu/csye6200/absim/boat.png";
//			System.out.println(ClassLoader.getSystemClassLoader().getResource("boat.png"));
//			URL[] urls = ((URLClassLoader) ClassLoader.getSystemClassLoader()).getURLs();
//	        for (URL url : urls) {
//	            System.out.println(url);
//	        }
			img = ImageIO.read(getClass().getResource("boat.png"));// Loading image of the Boat
//			img = ImageIO.read(MyCanvas.class.getClassLoader().getResource("../res/boat.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
