...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(ABApp application) {
	 ...
	 */
	public MenuManager(ABApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(ABApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(ABApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(ABApp application) {
			super("AboutAction");
			this.application = application;
		}
