...
//		boatList[0].moveTo(-8,-10);
		...
		BoatTask t1 = new BoatTask("Task 1", "Clean up Area 3", new DateTime(2020,10,11,12,1,1), boatList[0]);
		BoatTask t2 = new BoatTask("Task 2", "Clean up Area 6", new DateTime(2019,10,12,12,1,1), boatList[1]);
		BoatTask t3 = new BoatTask("Task 3", "Clean up Area 9", new DateTime(2020,10,13,12,1,1), boatList[2]);
		BoatTask t4 = new BoatTask("Task 4", "Clean up Area 4", new DateTime(2019,10,14,12,1,1), boatList[3]);
		BoatTask t5 = new BoatTask("Task 5", "Clean up Area 8", new DateTime(2020,10,15,12,1,1), boatList[4]);
		BoatTask t6 = new BoatTask("Task 6", "Clean up Area 2", new DateTime(2019,10,16,12,1,1), boatList[0]);
		BoatTask t7 = new BoatTask("Task 7", "Clean up Area 1", new DateTime(2020,10,17,12,1,1), boatList[1]);
		BoatTask t8 = new BoatTask("Task 8", "Clean up Area 4", new DateTime(2019,10,18,12,1,1), boatList[2]);
		BoatTask t9 = new BoatTask("Task 9", "Clean up Area 10", new DateTime(2020,10,19,12,1,1), boatList[3]);
		BoatTask t10 = new BoatTask("Task 10", "Clean up Area 5", new DateTime(2019,20,12,12,1,1), boatList[4]);
		...
		//Adding tasks in an unordered manner for sorting. 
		bs.addTask(t8);
		bs.addTask(t3);
		bs.addTask(t4);
		bs.addTask(t1);
