...
public class BoatIO {
	...
	private void save(Boat b, File f) {
		try {
			...
			e.printStackTrace();
			log.severe("Severe : IO Exception - save() method failed");// Sever logger for try-catch
	...
	public void loadBoat(Boat[] boatList, String fileName) {
		...
		try {
			...
			//First Splitting by '\n' to get Strings for each instance 
			...
			e.printStackTrace();
			log.severe("Severe : FileNotFoundException Exception - Couldn't find File "+fileName);// Sever logger for try-catch
		} catch (IOException e) {
			e.printStackTrace();
			log.severe("Severe : IO Exception - loadBoat() method failed");// Sever logger for try-catch
		}
	...
	public void saveBoat(Boat[] boatList, String fileName) {
			...
			try {
				...
				e.printStackTrace();
				log.severe("Severe : IO Exception - createNewFile() method failed");// Sever logger for try-catch
			}
