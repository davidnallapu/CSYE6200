...
public class BoatScheduler {
	...
	public void printTasks() {
		...
		for (BoatTask t : tasks) {
			System.out.println(String.format("%1$6s %2$8s %3$16s %4$2d-%5$2d-%6$4d %7$15s", t.id, t.taskName,t.Objective,t.startDate.month,t.startDate.day,t.startDate.year,t.assignedBoat.boatName));
